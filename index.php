        ...
        <div class="row">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    $db = Database::connect();
                    $statement = $db->query('SELECT burger_code.items.id, burger_code.items.name, burger_code.items.description, burger_code.items.price, burger_code.categories.name AS category FROM burger_code.items LEFT JOIN burger_code.categories ON burger_code.items.category = burger_code.categories.id ORDER BY burger_code.items.id DESC');
